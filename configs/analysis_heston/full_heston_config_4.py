...
class FullConfig:
    ...
    # ============================================================
    # 4 长期阴影风险环境（Long-Shadow / Post-Crisis Regime）
    # ------------------------------------------------------------
    # • 微笑：极陡，OTM Put 持续溢价
    # • 波动率：一旦抬升就长时间不回落，regime persistence 很强
    # • 走势：不靠单次崩盘，而是慢性风险侵蚀 PnL
    # • 对标：2009–2012 年 SPX，长期 macro 不确定期
    # ------------------------------------------------------------
    kappa: float = 0.8  # 回归极慢，高波状态“阴魂不散”
    theta: float = 0.04  # 长期波动中枢仍然偏高
    sigma: float = 0.23  # vol-of-vol 偏高但不过分
    rho: float = -0.60  # 极端 leverage effect
    # ============================================================
